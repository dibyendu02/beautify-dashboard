...
import { fetchServiceById, updateService, clearCurrentService } from '@/store/slices/serviceSlice';
import {
  ArrowLeft,
  Upload,
  X,
...
export default function EditServicePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await dispatch(updateService({ id: serviceId, data: formData })).unwrap();
